...
exports.createDonation = async (req, res) => {
    ...
    db.beginTransaction(async (err) => {
        ...
        try {
            ...
            await db.query(donationQuery, [DonorID, ProjectID, Amount, PayMode, Donation_Date]);
            ...
            await db.query(updateDonorQuery, [Amount, DonorID]);
            ...
            await db.query(updateProjectQuery, [Amount, ProjectID]);
